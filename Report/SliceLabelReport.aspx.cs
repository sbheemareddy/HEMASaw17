...
public partial class SliceLabelReport : System.Web.UI.Page
{
    ...
    {
        Database db = DatabaseFactory.CreateDatabase("HemaSaw");
        string sql = "spGetSliceLabel";
            ...
            namespace HEMASaw
{
    ...
    public void PrintReport(Report report, string printerName, Label lbl)
    {
        ...
        try
        {
            ...
            using (FileStream file = new FileStream(@"C:\Applications\ExceptionDetailsFile\Test" + RandomString(8) + ".pdf", FileMode.Create, System.IO.FileAccess.Write))
            {
